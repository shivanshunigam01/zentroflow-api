...
import { downloadTemplate, generateImportIds, getLastImport, importLeads, validateImport, bulkWhatsAppCampaign, bulkWhatsAppCount, bulkWhatsAppReport, createLead } from '../controllers/leads.controller.js';
...
const longWhatsAppReport = longRunningRequest(120000);
...
router.get('/bulk-whatsapp/report', longWhatsAppReport, bulkWhatsAppReport);
